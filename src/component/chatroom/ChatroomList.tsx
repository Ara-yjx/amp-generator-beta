...
import {
  ChatroomSummary,
  createChatroom as createChatroomRequest,
  listChatrooms,
} from '../../data/chatroom/api'
import { defaultChatroomSetting } from '../../data/chatroom/chatroomSetting'
...
export default function ChatroomList() {
  ...
  const createChatroom = async () => {
    ...
    try {
      ...
      await createChatroomRequest(newName.trim(), setting)
