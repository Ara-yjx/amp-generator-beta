...
export interface DataTabProps {
  rawData: CsvRow[] | null;
  selectedData: CsvRow[] | null;
  processedData: CsvRow[] | null;
  selectedVars: string[];
  setSelectedVars: React.Dispatch<React.SetStateAction<string[]>>;
  format: DataFormat;
  setFormat: React.Dispatch<React.SetStateAction<DataFormat>>;
  cleaningOptions: CleaningOptions;
  setCleaningOptions: React.Dispatch<React.SetStateAction<CleaningOptions>>;
  confirmedVars: boolean;
  dataReshaped: boolean;
...
const DataTab: React.FC<DataTabProps> = ({
  ...
  const handleCleaningOptionChange = <K extends keyof CleaningOptions>(option: K, value: CleaningOptions[K]) => {
    setCleaningOptions({
      ...cleaningOptions,
      [option]: value,
    });
